## Library used installed packages
library(data.table)
library(dplyr)
...
##write.table
write.table(tidyData, file = "/Users/Bissy/Desktop/UCI\ HAR\ Dataset\ /Tidy.txt", row.names = FALSE)
## To read table
View(read.table("/Users/Bissy/Desktop/UCI\ HAR\ Dataset\ /Tidy.txt", header=TRUE))
